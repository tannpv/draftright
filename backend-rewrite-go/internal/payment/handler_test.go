...
func TestMethodsHandler(t *testing.T) {
	h := NewHandler(NewService(fakeRepo{}, fakeSettings{csv: "stripe", found: true}, "", nil, nil, nil, nil, nil))
...
func TestStatusHandler_NotFound(t *testing.T) {
	h := NewHandler(NewService(fakeRepo{status: nil}, fakeSettings{}, "", nil, nil, nil, nil, nil))
	rec := httptest.NewRecorder()
...
func TestHistoryHandler_Empty(t *testing.T) {
	h := NewHandler(NewService(fakeRepo{hist: nil}, fakeSettings{}, "", nil, nil, nil, nil, nil))
	rec := httptest.NewRecorder()
...
func TestHistoryHandler_MissingClaims(t *testing.T) {
	h := NewHandler(NewService(fakeRepo{}, fakeSettings{}, "", nil, nil, nil, nil, nil))
	rec := httptest.NewRecorder()
