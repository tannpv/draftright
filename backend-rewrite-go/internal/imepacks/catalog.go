...
func wordlist(base, stem string) *LanguagePack {
	return &LanguagePack{URL: base + "/" + stem, Version: 1, SizeBytes: 0, SHA256: "", MinEngineVersion: 1}
}

// Catalog returns the frozen language-module catalog in declared order.
// Byte-identical to the NestJS ime-packs `modules` array. base is the CDN
// origin pack URLs are built from (config.IMEPackBase) — injected so dev/
// test can repoint without touching this file.
func Catalog(base string) []LanguageModule {
	return []LanguageModule{
		{ID: "en", DisplayName: "English", InputMethod: "passthrough", Engine: "none", Layout: "qwerty", Bundled: true,
			WordlistPack: wordlist(base, "draftright-wordlist-en-v1.tsv")},
		{ID: "vi", DisplayName: "Tiếng Việt", InputMethod: "composition", Engine: "composition", Layout: "qwerty", Bundled: true,
			WordlistPack: wordlist(base, "draftright-wordlist-vi-v1.tsv")},
		{ID: "fr", DisplayName: "Français", InputMethod: "composition", Engine: "composition", Layout: "qwerty", Bundled: true,
			WordlistPack: wordlist(base, "draftright-wordlist-fr-v1.tsv")},
		...
		{ID: "ja", DisplayName: "日本語", InputMethod: "candidate", Engine: "dictionary", Layout: "romaji", Bundled: false,
			Pack: &LanguagePack{URL: base + "/draftright-ime-ja-v3.pack", Version: 3, SizeBytes: 2016095,
		...
		{ID: "zh", DisplayName: "中文", InputMethod: "candidate", Engine: "dictionary", Layout: "pinyin", Bundled: false,
			Pack: &LanguagePack{URL: base + "/draftright-ime-zh-v1.pack", Version: 1, SizeBytes: 1907323,
