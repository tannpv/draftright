...
## 2.3.65 — 2026-08-16
### macOS
- The rewrite pencil no longer appears on a plain click — only when you actually drag to highlight text.
...
## 2.3.59 — 2026-08-15
### macOS
- Simplified the trigger setting to **Pencil** or **Hotkey** — pick one. The "Both" option has been removed.
...
- The rewrite pencil now appears only when you highlight text by dragging, not when you double-click a word.
