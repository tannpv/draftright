...
export class FeedbackController {
  ...
  constructor(
    private readonly feedback: BugReportsService,
  ...
  async create(@Body() dto: CreateFeedbackDto, @Req() req: Request) {
    ...
    const row = await this.feedback.createFeedback(dto, this.jwtUser.decodeOptional(req));
  ...
  async list(
    ...
    return this.feedback.listPublicFeatures(q as any, this.jwtUser.decodeOptional(req));
  }
