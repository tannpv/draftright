...
/// Uses Win32 SendInput and clipboard APIs. The pure selection-capture decision
/// (DecideCapture + SelectionCapture / SelectionCaptureStatus) lives in
/// ClipboardCaptureDecision.cs so it can be unit-tested headless (#80).
/// </summary>
public sealed partial class ClipboardService
{
    ...
    // DecideCapture (+ SelectionCapture / SelectionCaptureStatus) moved to
    // ClipboardCaptureDecision.cs so the headless test project can compile it
    // without this file's P/Invoke + DRLogger (#80).
